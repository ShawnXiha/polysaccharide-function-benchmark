# Cover Letter Template: Journal of Cheminformatics
...
The study is designed to be reproducible. The benchmark construction steps, split artifacts, baseline implementations, and supplementary benchmark notes are prepared for release alongside the submission package. The manuscript also explicitly reports a stricter DOI-grouped split and paired bootstrap analysis, which substantially narrows the main claim and clarifies the current limits of grouped generalization.

This manuscript is original, is not under consideration elsewhere, and all authors have approved the submission. We believe the paper will be of interest to readers working at the intersection of cheminformatics, glycobioinformatics, benchmark construction, and interpretable structure-based machine learning.
