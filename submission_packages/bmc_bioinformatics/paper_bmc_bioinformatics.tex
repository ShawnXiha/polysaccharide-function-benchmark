...
KG: knowledge graph; GNN: graph neural network; MRR: mean reciprocal rank; DOI: digital object identifier.
...
Supplementary Table S1 summarizes the biology-facing case-study evidence, and Supplementary Table S2 clarifies the interpretation of exact match in the GNN failure ablation. These materials are distributed as a separate supplementary PDF together with the submission package.
