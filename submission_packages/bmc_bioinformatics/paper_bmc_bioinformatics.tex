...
% Author metadata and repository URL partially filled.
% Corresponding-author contact details still need to be designated before submission.
...
The benchmark construction scripts, split definitions, baseline implementations, and supplementary benchmark statistics used in this study are available in the project repository and associated submission package at \url{https://github.com/ShawnXiha/polysaccharide-function-benchmark}. The main manuscript results are based on the DoLPHiN-derived filtered benchmark artifact \path{dataset_publishable_supervised_v1}, together with the fixed random and DOI-grouped split files described in the supplementary reproducibility materials.
...
QX designed the study, implemented the benchmark and experiments, analyzed the results, and drafted the manuscript. The author approved the final version.
