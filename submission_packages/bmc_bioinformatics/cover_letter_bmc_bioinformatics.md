# Cover Letter Template: BMC Bioinformatics
...
The manuscript is intentionally careful in its claims. It reports a modest random-split macro-F1 gain for the final `poly-core v1` representation, but also includes paired bootstrap analysis and a stricter DOI-grouped split showing that this gain is split-sensitive rather than robustly universal. We believe this combination of benchmark construction, honest robustness analysis, and interpretable feature insight will be of interest to the journal's readership.

This manuscript is original, is not under consideration elsewhere, and all authors have approved the submission.
