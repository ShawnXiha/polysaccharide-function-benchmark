"""Run a TF-IDF + logistic regression multilabel baseline."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run TF-IDF logistic regression baseline")
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=EXPERIMENTS / "revision_p1" / "tfidf_logistic_random_test.json",
    )
...
def main() -> None:
    ...
    result = {
        ...
        "note": "TF-IDF baseline over combined structured text fields",
    }
    write_json(args.output, result)
    print(f"Wrote TF-IDF logistic baseline result to {args.output}")
